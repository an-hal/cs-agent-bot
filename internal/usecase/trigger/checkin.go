...
func (t *TriggerService) evalBranchA(ctx context.Context, c entity.Client, f entity.ClientFlags, dte int) (bool, error) {
	...
	if dte <= 120 && !f.CheckinA1FormSent {
		if err := t.sendMessage(ctx, "TPL-CHECKIN-FORM", "CHECKIN_A1_FORM_SENT", c, nil); err != nil {
			return false, err
		}
	...
	if dte <= 113 && f.CheckinA1FormSent && !f.CheckinA1CallSent {
		if err := t.sendMessage(ctx, "TPL-CHECKIN-CALL", "CHECKIN_A1_CALL_SENT", c, nil); err != nil {
			return false, err
		}
	...
	if dte <= 90 && !f.CheckinA2FormSent {
		if err := t.sendMessage(ctx, "TPL-CHECKIN-FORM", "CHECKIN_A2_FORM_SENT", c, nil); err != nil {
			return false, err
		}
	...
	if dte <= 83 && f.CheckinA2FormSent && !f.CheckinA2CallSent {
		if err := t.sendMessage(ctx, "TPL-CHECKIN-CALL", "CHECKIN_A2_CALL_SENT", c, nil); err != nil {
			return false, err
		}
...
func (t *TriggerService) evalBranchB(ctx context.Context, c entity.Client, f entity.ClientFlags, dte int) (bool, error) {
	...
	if dte <= 90 && !f.CheckinB1FormSent {
		if err := t.sendMessage(ctx, "TPL-CHECKIN-FORM", "CHECKIN_B1_FORM_SENT", c, nil); err != nil {
			return false, err
		}
	...
	if dte <= 83 && f.CheckinB1FormSent && !f.CheckinB1CallSent {
		if err := t.sendMessage(ctx, "TPL-CHECKIN-CALL", "CHECKIN_B1_CALL_SENT", c, nil); err != nil {
			return false, err
		}
	...
	if dte <= 60 && !f.CheckinB2FormSent {
		if err := t.sendMessage(ctx, "TPL-CHECKIN-FORM", "CHECKIN_B2_FORM_SENT", c, nil); err != nil {
			return false, err
		}
	...
	if dte <= 53 && f.CheckinB2FormSent && !f.CheckinB2CallSent {
		if err := t.sendMessage(ctx, "TPL-CHECKIN-CALL", "CHECKIN_B2_CALL_SENT", c, nil); err != nil {
			return false, err
		}
