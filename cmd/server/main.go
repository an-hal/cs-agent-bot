...
func assembleDeps(
	...
	masterDataUsecase := masterdatauc.New(repos.masterData, repos.customField, repos.masterDataMutation, repos.approvalRequest, repos.importSession, repos.clientContact)
