...
**Total: ±252 routes** (after Wave C1-C3 additions closing FE-spec gaps).
Complete Postman v2.1 collection at
`docs/postman/cs-agent-bot.postman_collection.json` — 29 folders, 229 requests.
